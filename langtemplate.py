...
templates = ['إسبا', 'بولندية', 'لغة-إيطالية', 'لغ-سوي', 'لات', 'لغة-ألمانية', 'بنغالية', 'اللغة-الهولندية', 'تر', 'اللغة-التركية', 'اللغة-الفارسية', 'اللغة-الفرنسية', 'إسب', 'اللغة-الإسبانية', 'لغة-يونانية', 'إنج', 'فرن']
